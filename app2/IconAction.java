...
public class IconAction extends AbstractCyAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        */
        ...
        manager.command(null, "network load file file='STRING network - Homo_sapiens_filt.cyjs'"/*, "table import file file='Elysia_Bioscience_Data_Res.xlsx' caseSensitiveNetworkCollectionKeys=false dataTypeTargetForNetworkCollection='Node Table Columns' firstRowAsColumnNames=true, keyColumnForMapping=stringdb_canonical_name targetNetworkCollection='STRING network - Homo sapiens_nat.cyjs' whereImportTable='Network Collection' keyColumnIndex=20 startLoadRow=1"*/);
